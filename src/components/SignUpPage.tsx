...
export function SignUpPage({ onSignUp, onSignInClick, onBack, theme, setTheme }: SignUpPageProps) {
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-black dark:bg-zinc-950 relative items-center justify-center overflow-hidden border-r border-white/5">
                ...
                <div className="relative z-10 max-w-md p-12">
                    ...
                    <p className="text-zinc-400 text-lg font-medium leading-relaxed">
                        Create your account today and gain access to thousands of daily tasks, high-multiplier bonuses, and a global network of creators.
                    </p>
                </div>
            </div>
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-6 md:p-12 relative">
                ...
                <div className="w-full max-w-sm">
                    ...
                    <div className="hidden lg:block mb-10">
                        ...
                        <p className="text-zinc-500 dark:text-zinc-400 font-medium">Join 50k+ creators today</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <User className="absolute left-0 top-1/2 -translate-y-1/2 size-4 text-zinc-400" />
                                <input 
                                    type="text" 
                                    value={name}
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <button
                                    ...
                                    className="absolute right-0 top-1/2 -translate-y-1/2 text-zinc-455 hover:text-zinc-800 dark:hover:text-zinc-200 transition-colors"
                                >
                        ...
                        <div className="space-y-2">
                            <label className="text-[10px] font-black text-zinc-400 uppercase tracking-widest">Referral Code (Optional)</label>
                            <div className="relative">
                                <Zap className="absolute left-0 top-1/2 -translate-y-1/2 size-4 text-zinc-400" />
                                <input 
                                    type="text" 
                                    value={referralCode}
                    ...
                    <div className="mt-10 pt-10 border-t border-zinc-100 dark:border-white/5 text-center">
                        <p className="text-zinc-500 dark:text-zinc-400 text-sm font-medium">
                            Already a member? <button type="button" onClick={onSignInClick} className="text-blue-600 dark:text-blue-400 hover:text-blue-500 font-bold transition-colors">Sign in here</button>
                        </p>
                    </div>
                </div>
            </div>
